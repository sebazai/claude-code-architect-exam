...
- **60 questions** across 4 randomly-selected scenarios (15 per scenario)
- **120-minute timer** that runs only while you are reading and answering — generation and evaluation time is excluded
...
Claude Code (host / MCP client)
  │
  ├── start_exam          → pick 4 random scenarios, initialise session
...
| Raw correct answers (of 60) | Scaled score |
|---|---|
| 60 | 1000 |
| ~39 | 720 (passing) |
| 0 | 100 |
